    ...
    return (
        <div className={styles.container}>
            <Yard className={styles.banner}>
                ...
                <img src="https://github.com/lamlinhh/Travel_Web/blob/Linh/assets/Images/pexels-jarod-17350906_wqirdn.jpg?raw=true" alt="Paris" />
            </Yard>
            <Yard className={styles.tourContent}>
                <Area className={styles.bread}>
                    <Block >
                        <Text fontSize={"16px"} ><span><Link href={"/"}>Home</Link></span>/France/Paris/Tours</Text>
                    </Block>
                    <Block>
                        <Text fontSize={"24px"} bold>All Tours and Activities in Paris</Text>
                    </Block>
                </Area>
